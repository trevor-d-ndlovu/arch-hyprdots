...
if hyprdots-hw-dell-xps-haptic-touchpad; then
  ...
  sudo rm -f /etc/hyprdots-dell-haptic-touchpad.env
  sudo systemctl daemon-reload
  sudo udevadm control --reload-rules

  source "$HYPRDOTS_PATH/install/packaging/dell-xps-touchpad-haptics.sh"
fi
