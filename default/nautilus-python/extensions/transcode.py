...
class TranscodeAction(GObject.GObject, Nautilus.MenuProvider):
    def _launch_transcode(self, paths):
        wrapper = shutil.which("hyprdots-launch-floating-terminal-with-presentation")
        binary = shutil.which("hyprdots-transcode")
    ...
    def _make_item(self, paths):
        ...
        item = Nautilus.MenuItem(
            name="HyprdotsTranscodeNautilus::transcode",
            label=label,
    ...
    def _tools_available(self):
        return bool(
            shutil.which("hyprdots-launch-floating-terminal-with-presentation")
            and shutil.which("hyprdots-transcode")
        )
