--
-- Dynamic Hyprdots Theme Menu for Elephant/Walker
--
Name = "hyprdotsthemes"
NamePretty = "Hyprdots Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/hyprdots/themes"
  local hyprdots_path = os.getenv("HYPRDOTS_PATH") or ""
  local default_theme_dir = hyprdots_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "hyprdots-theme-set " .. theme_name,
            },
          })
        end
      end
